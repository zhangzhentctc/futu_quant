...
class dbop_ma_trand:
    ...
    def dbop_add_day_data(self, db_basic, id, cur, time, zma10, zma20, zma10_ratio, zma20_ratio, zma10_ratio_ratio, zma20_ratio_ratio, zma_gap, zma_gap_ratio, zma_gap_ratio_ratio, zma_gap_ratio_ratio_r, trade_mark, cur_ratio):
        sql = "insert into day_data_new2(id,cur,time, zma10,zma20, zma10_ratio, zma20_ratio, zma10_ratio_ratio, zma20_ratio_ratio, zma_gap, zma_gap_ratio, zma_gap_ratio_ratio, zma_gap_ratio_ratio_r, trade_mark, cur_ratio) values(" + \
              str(id) + "," + str(cur) + ", '" + str(time) + "' ," + str(zma10) + "," + str(zma20) + "," + \
              str(zma10_ratio) + "," + str(zma20_ratio) + "," + str(zma10_ratio_ratio) + "," + str(zma20_ratio_ratio) + "," + \
              str(zma_gap) + "," + str(zma_gap_ratio) + "," + str(zma_gap_ratio_ratio) + "," + str(zma_gap_ratio_ratio_r) + "," + str(trade_mark) + "," + str(cur_ratio) + ");"
        db_basic.insertMysql(sql)
